...
27. Table C.3: Lengths of Missing Blocks `run_appendix_plots.ipynb` code located (src/plots_and_tables/section_2.py) result written to `images-pdfs/section2/`
28. Figure D.1: Missing Observations over Time By Characteristics `run_appendix_plots.ipynb` code located (src/plots_and_tables/section_2.py) result written to ``
