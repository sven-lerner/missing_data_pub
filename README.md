...
12. Table 3: Imputation Error for Different Imputation Methods `run_section_5_plots.ipynb` code located (src/plots_and_tables/section_5.py) and (src/plots_and_tables/section_5.py#L331)  result written to `images-pdfs/section5/[AggregateImputationErrorsFullDataset.tex, AggregateImputationR2FullDataset.tex]`
...
26. Table C.2: Missing by Characteristic Quintiles `run_appendix_plots.ipynb` code located (src/plots_and_tables/section_2.py) result written to `images-pdfs/section2/`
27. Table C.3: Lengths of Missing Blocks `run_appendix_plots.ipynb` code located (src/plots_and_tables/section_2.py#L445) result written to `images-pdfs/section2/`
28. Figure D.1: Missing Observations over Time By Characteristics `run_appendix_plots.ipynb` code located ()
29. Figure D.2: Missing Observations by Characteristic Pooled by Stocks `run_appendix_plots.ipynb` code located ()
30. Figure D.3: Heatmap of Pairwise Correlation from 1967–1976 NOT INCLUDED AS TRUNCATED DATA DOES NOT INCLUDE THESE YEARS
31. Figure D.4: Standard Deviation of Characteristic Ranks `run_appendix_plots.ipynb` code located ()
